...
If you want to infer the network on Ascend 310, you should convert the model to MINDIR or AIR. You can specify the device for execution by setting "export DEVIDE_ID=xxx", default value is 0:
