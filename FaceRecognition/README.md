...
- Prepare the test dataset and set "test_dir='/path_to_test_dataset/'" on inference_xxx.yaml file, before evaluate network.
- Prepare the trained model(.ckpt file), set "weight='/path_to_checkpoint_path/model.ckpt'" on inference_xxx.yaml file.
